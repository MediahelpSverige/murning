...
function twentysixteen_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Copyright Text', 'twentysixteen' ),
		'id'            => 'sidebar-1',
...
/*custom banner post*/
add_action( 'init', 'OurBanner' );

function OurBanner() {

// Set UI labels for Custom Post Type
	$labels = array(
		'name'                => __( 'Banner', 'O_M_Gustavssons' ),
		'singular_name'       => __( 'Banner', 'O_M_Gustavssons' ),
		'menu_name'           => __( 'Banner', 'O_M_Gustavssons'),
		'parent_item_colon'   => __( 'Parent Team', 'O_M_Gustavssons'),
		'all_items'           => __( 'All Team', 'O_M_Gustavssons' ),
	);
	
// Set other options for Custom Post Type
	
	$args = array(
		'label'               => __( 'Banner', 'O_M_Gustavssons'),
		'description'         => __( 'My Banner' , 'O_M_Gustavssons'),
		'labels'              => $labels,
 ...
 function social_customizer( $wp_customize ) {
   $wp_customize->add_section(
       ...
       array(
           ...
           'description' => 'Insert Your Site Contant information',
           'priority' => 35,
       )
   );
...
function footerCopyright_customizer( $wp_customize ) {
   $wp_customize->add_section(
       'example_section_two',
       array(
           'title' => 'Footer Copyright information',
           'description' => 'Insert Your Site Copyright information',
           'priority' => 36,
       )
   );
   $wp_customize->add_setting(
